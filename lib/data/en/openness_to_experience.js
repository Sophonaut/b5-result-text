module.exports = {
  ...
  shortDescription: 'Openness to Experience differentiates those who tend to be imaginative and curious, from those who are more conventional and down-to-earth///////.',
  description: `Openness "should not be confused with self-disclosure 
  (being willing to talk about one's inner feelings); instead, it refers to a 
  receptiveness to new ideas, approaches, and experiences. (book pg 46)". Open people are intellectually curious,
...
think and act in individualistic and non-conforming
...
General: cite from book `,
  results: [
    {
      score: 'low', // do not translate this line
      text: `You scored [X%] in Openness to Experience which is low. Specifically, out of 100 people you are
      less open than [1-X%], indicating you tend to be more down-to-earth, conventional, conservative, and 
      prefer routine more than [1-X%] of people. People who are closed to experience are not necessarily defensive, 
      nor are they necessarily narrow-minded in the sense of being judgmental and intolerant. Instead, they are 
      characterized by a preference for the familiar, practical, and concrete, and a lack of interest in experience 
      for its own sake. [book pg 46]"
      <br /><br />
      Superpower:  Being less open than others, you are less likely to entertain new ideas, values, or activities for
      their own sake. This allows you to more thoroughly consider  downsides and bring a discerning voice to conversations,
      necessitating a "look before you leap" perspective. Without this perspective, the conversation may have been 
      dominated by unconstrained optimism leading to a possibly disastrous result. 
      <br /><br />
      Blindspot:  [discuss with Peter]`
    },
    {
...
Blindspot:  `
    },
    {
      ...
      text: `You scored [X%] in Openness to Experience which is high. Specifically, out of 100 people you are
      more open than [1-X%], indicating you tend to be more creative, curious, liberal, and prefer variety more 
      than [1-X%] of people. You tend to be more interested in having new experiences for their own sake, and 
