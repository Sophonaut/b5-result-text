...
can result in less goals achieved an lower life satisfaction. On
  ...
  results: [
    {
      ...
      text: `You scored [X%] in Conscientiousness which is low. Specifically, out of 100 people you are
      less conscientious than [1-X%], indicating you tend to be more negligent, lazy, late, 
      aimless, and inconsistent than [1-X%] of people. You prefer to live for the moment and do what feels good now, 
...
Blindspot:  `
    },
    {
      ...
      more conscientious than [1-X%], indicating you tend to be more hardworking, well-organized, 
      punctual, ambitious, and preserving than [1-X%] of people. You tend to set clear goals and pursue 
...
in control of their lives.`
    },
    {
      facet: 2,
      title: 'Order',
      text: `People with high scores on orderliness tend to be 
