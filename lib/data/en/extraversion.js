...
to get along with, and congeniality easily turn to leadership.`,
  results: [
    {
      score: 'low', // do not translate this line
      text: `You scored low in Extraversion meaning you are less extraverted than most people. 
      This indicates that you tend to be more reserved, quiet, passive, and introverted
       than others. You tend to prefer solitude and solitary activities, and when you are social you 
...
others but also time alone.`
    },
    {
      ...
      text: `You scored high in Extraversion meaning you are more extraverted than most people. 
      This indicates that you tend to be more affectionate, talkative, active, 
      fun-loving, and passionate than others. You prefer to be around people as opposed to 
      having solitude.`
    }
  ],
  facets: [
